...
class _MarketplaceScreenState extends State<MarketplaceScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final statsRaw = await LocalDataService.instance.get(
        '/marketplace/mine/stats',
      );
        ...
        onSelected: (value) async {
          try {
            if (value == 'edit') {
              ...
              await LocalDataService.instance.post(
                '/marketplace/${item.id}/relist',
              );
            } else if (value == 'delete') {
              await LocalDataService.instance.delete('/marketplace/${item.id}');
            }
            onChanged?.call();
          } on LocalDataFailure catch (error) {
